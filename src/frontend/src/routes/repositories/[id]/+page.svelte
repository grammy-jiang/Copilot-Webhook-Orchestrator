			...
			{:else if repository}
					...
					<div class="flex items-start justify-between gap-4">
						...
						<div class="flex items-center gap-2">
							...
							<a
								...
								class="inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md border border-input bg-background px-4 py-2 text-sm font-medium shadow-sm transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 24 24"
				...
				<section class="space-y-4">
					...
					{#if events.length === 0}
						<EmptyState
							title="No events yet"
							description="Events will appear here when GitHub sends webhooks for this repository. Try pushing code, opening an issue, or creating a pull request."
						/>
					{:else}
